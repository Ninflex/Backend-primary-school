            ...
            <div class="col">
                <div class="card mt-5">
                    <div class="card-header">
                        <h2 class="display-6 text-center">Parent Database</h2>
                    </div>
                    <div class="card-body">
                        <table class="table table-bordered text-center">
                            ...
                            <td><?php echo $row['ParentPhoneNumber']; ?></td>
                            <?php echo "<td><a class='btn btn-primary' href='Parentedit.php?ParentID=" .$row['ParentID'] ."'> Edit</a></td>" ?>
                            <?php echo "<td><a class='btn btn-danger' href='Parentdelete.php?ParentID=" .$row['ParentID'] ."'> Delete</a></td>" ?>
                            </tr>
                            <?php
                                }
                            ?>
                        ...
                        <div class="form-group"><br>
                            <a class="btn btn-primary form-control" href="Parentadd.php"> Add</a>
                        </div>
                </div>
            </div>
        </div>
