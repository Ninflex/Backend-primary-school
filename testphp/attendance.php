            ...
            <div class="col">
                <div class="card mt-5">
                    <div class="card-header">
                        <h2 class="display-6 text-center">Attendance</h2>
                    </div>
                    <div class="card-body">
                        <table class="table table-bordered text-center">
                            ...
                            <?php echo "<td><a class='btn btn-primary' href='Attendanceedit.php?AttendanceID=" .$row['AttendanceID'] ."'> Edit</a></td>" ?>
                            <?php echo "<td><a class='btn btn-danger' href='Attendancedelete.php?AttendanceID=" .$row['AttendanceID'] ."'> Delete</a></td>" ?>
                            </tr>
                            <?php
                                }
                            ?>
                        ...
                        <div class="form-group"><br>
                            <a class="btn btn-primary form-control" href="Attendanceadd.php"> Add</a>
                        </div>
                </div>
            </div>
        </div>