            ...
            <div class="col">
                <div class="card mt-5">
                    <div class="card-header">
                        <h2 class="display-6 text-center">Medical Database</h2>
                    </div>
                    <div class="card-body">
                        <table class="table table-bordered text-center">
                            ...
                            <?php echo "<td><a class='btn btn-primary' href='Medicaledit.php?MedicalID=" .$row['MedicalID'] ."'> Edit</a></td>" ?>
                            <?php echo "<td><a class='btn btn-danger' href='Medicaldelete.php?MedicalID=" .$row['MedicalID'] ."'> Delete</a></td>" ?>
                            </tr>
                            <?php
                                }
                            ?>
                        ...
                        <div class="form-group"><br>
                            <a class="btn btn-primary form-control" href="Medicaladd.php"> Add</a>
                        </div>
                </div>
            </div>
        </div>
